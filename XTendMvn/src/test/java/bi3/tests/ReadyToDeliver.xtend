...
class ReadyToDeliver extends BaseTest {
...
//		ois101e.fillPricingInformation("350","325");
		...
		var fullScheduleNum = pms170.getLastJoindScheduleNo()
		pms170b.clickNext();
		pms170b.RefreshPage();
		...
		pms100_b.SearchScheduleNo(fullScheduleNum)
		...
		mws410b.AddToPickingList(fullScheduleNum);
