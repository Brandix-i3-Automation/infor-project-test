...
class PMSOperations extends BasePage {
...
//	WebElement gridFirstLine;
	...
	@FindBy(xpath="//a//*[contains(text(), 'Report Operations')]") // a[text()='Report Issue']/span
	...
	def void enterScheduleNumber() {

		Thread.sleep(1000);
		txtSchedule.click();
		txtSchedule.sendKeys("12");
