...
public class PMSOperations extends BasePage {
  public PMSOperations(final WebDriver driver) {
    super(driver);
  }
  ...
  @FindBy(css = "div[class=\'inforTriggerField focus\']>input")
  ...
  public void enterScheduleNumber() {
    try {
      Thread.sleep(1000);
      this.txtSchedule.click();
      this.txtSchedule.sendKeys("12");
    } catch (Throwable _e) {
      throw Exceptions.sneakyThrow(_e);
    }
  }
