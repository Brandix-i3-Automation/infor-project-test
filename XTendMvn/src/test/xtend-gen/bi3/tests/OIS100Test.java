...
public class OIS100Test extends BaseTest {
  ...
  public void CustomerOrderCreation() {
    ...
    this.ois101B1.fillOrderLine("Y3203", "30");
    ...
    this.crs207B.handleAbnormalException();
    this.ois101e.fillPricingInformation("350", "300");
    this.crs207B.handleAbnormalException();
    this.ois101e.fillPricingInformation("350", "325");
  }
}
